<template>
  ...
  >
    <div class="bg-black h-full w-full text-white overflow-auto">
        ...
        <div class="py-2 w-full">
          ...
          <div class="relative flex items-center w-full">
            <div class="w-[42px] mx-auto">
              <div
                class="absolute ml-4 mt-1 top-0 w-[1px] bg-gray-7700 h-full"
              />
            </div>
            <div
                ...
                <div class="flex flex-col gap-2 py-1">
                  <div v-if="fileDisplay">
                    <img
                      :src="fileDisplay"
                      alt="file display"
                      class="mx-auto w-50 mt-2 mr-2 rounded-lg"
                    />
      ...
      >
        <div class="" v-if="!isLoading">Post</div>
...
// import { CreatePost } from "../.nuxt/components";
